...
### TITIK WARNA ###
R_I_A_Z_ = "\x1b[1;91m•\x1b[1;93m•\x1b[1;92m•"
R_I_A_Z_ = "\x1b[1;92m•\x1b[1;93m•\x1b[1;91m•"
____irpan__clear____
### LOGOO TOOLS ###
def _____logo_____():
    ____irpanganteng____(f""" 
\n{P}                 {RK}{RIAZ}{KHAN}  
{P}   ╭─────────{___R_I_A_Z___}{KHAN} {RK} {A} {___RK___}{P}─────────╮
{P}   │  ©{U}██████  ██  █████  ███████  {P} │
{P}   │     {U}██   ██ ██ ██   ██    ███  {P} │
{P}   │     {U}██████  ██ ███████   ███{P} │
{P}   │     {U}██   ██ ██ ██   ██  ███      {P} │
...
____irpanganteng____(f'{P}        ╭──────┴─{___RIAZ___}    {___KHAN___}{P}─┴──────╮')
____irpanganteng____(f'{P}        ├────┬───────────────┬─────┤')
...
try:
  if ____pilih____ in ['1','01']: #AUTO FOLLOWERS
    ...
    ____irpanganteng____(f'{P}╰────────────┬───────────────┬────────────╯')
    ____irpanganteng____(f'{P}             ░               ░')
    ____irpanganteng____(f'{P}  ╭──────────┴───{R_I_A_Z_}   {R_I_A_Z_}{P}───┴──────────╮')
